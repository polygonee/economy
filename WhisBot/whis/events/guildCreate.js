...
module.exports = guild => {
  ...
  if(owner !== settings.ownerid){
    ...
    channel.send(`Thanks for inviting me into this server! Please do wh.info and wh.help for the informations you need in order for the bot to work properly. Do wh.suggest or wh.bug if there's any suggestions or bug you found. THANKS`);
